      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12">
          <div className="bg-[#000a1a] border border-white/5 rounded-lg p-5 text-center">
            <div className="font-display text-3xl text-[#A67C52]">4.9</div>
          ...
          <div className="bg-[#000a1a] border border-white/5 rounded-lg p-5 text-center">
            <div className="font-display text-3xl text-[#A67C52]">340+</div>
            <div className="text-xs text-[#5C677D] mt-2">Отзывов</div>
          </div>
          <div className="bg-[#000a1a] border border-white/5 rounded-lg p-5 text-center">
            <div className="font-display text-3xl text-[#A67C52]">98%</div>
            <div className="text-xs text-[#5C677D] mt-2">Рекомендуют</div>
          </div>
          <div className="bg-[#000a1a] border border-white/5 rounded-lg p-5 text-center">
            <div className="font-display text-3xl text-[#A67C52]">5★</div>
        ...
        <div className="mb-10">
          <button
            ...
            className="bg-[#A67C52] hover:bg-[#BC6C25] text-[#000814] px-8 py-3 rounded-md font-medium text-sm transition-colors"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex items-center gap-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      ...
                      >
                        <Star
                          className={`w-7 h-7 ${
                            star <= formData.rating ? 'text-[#A67C52]' : 'text-[#5C677D]'
                          }`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#000814] border border-white/10 rounded-md px-4 py-3 text-sm text-[#C5C3C6] focus:outline-none focus:border-[#A67C52] transition-colors resize-none"
                    placeholder="Расскажите о вашем опыте..."
                  />
                </div>
                <button
                  type="submit"
                  className="flex items-center gap-2 bg-[#A67C52] hover:bg-[#BC6C25] text-[#000814] px-6 py-3 rounded-md font-medium text-sm transition-colors"
                >
        ...
        <div className="space-y-4">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="bg-[#000a1a] border border-white/5 rounded-lg p-6 hover:border-[#A67C52]/10 transition-colors"
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-[#A67C52]/20 to-[#BC6C25]/20 rounded-full flex items-center justify-center shrink-0">
                  <span className="font-display text-lg text-[#A67C52]">
